...
/**
 * Created by dralagen on 11/23/15.
 */
public class EscapingDoublequote {
    ...
    public void setUp() throws Exception {
        ...
        csvInput = SimpleParseTest.class.getResourceAsStream("/csv/escapingDoublequote.csv");
    }
    ...
    public void simpleTest() {
        ...
        InputStream expected = SimpleParseTest.class.getResourceAsStream("/xml/escapingDoublequote.xml");
    ...
    public void simpleCompactTest() {
        ...
        InputStream expected = SimpleParseTest.class.getResourceAsStream("/xml/escapingDoublequoteCompact.xml");
